...
- **Name:** Suleyman Esendal
- **GitHub Username:** suleyman-esendal
- **Classroom Role:** Student
- **Week 1 Repository:** https://github.com/suleyman-esendal/git-foundations-portfolio
...
- **Final Practice Note:** Completed the full branch, edit, commit, push, PR cycle independently as the Week 2 closing exercise.